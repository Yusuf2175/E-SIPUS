                                ...
                                <div class="flex-1 p-6">
                                    ...
                                    <div class="flex items-center justify-between pt-4 border-t border-slate-100">
                                        ...
                                        @elseif(Auth::id() === $review->user_id)
                                            {{-- User: Edit & Hapus ulasan sendiri --}}
                                            <div class="flex items-center gap-2">
                                                <button type="button"
                                                        onclick="openEditModal({{ $review->id }}, {{ $review->rating }}, {{ json_encode($review->review) }})"
                                                        class="inline-flex items-center gap-1.5 text-blue-600 hover:text-white hover:bg-blue-600 font-medium text-sm px-4 py-2 rounded-xl transition-all border-2 border-blue-200 hover:border-blue-600">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <form action="{{ route('reviews.destroy', $review) }}" method="POST"
                                                    ...
                                                    @method('DELETE')
                                                    <button type="submit"
                                                            class="inline-flex items-center gap-1.5 text-red-600 hover:text-white hover:bg-red-600 font-medium text-sm px-4 py-2 rounded-xl transition-all border-2 border-red-200 hover:border-red-600">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
