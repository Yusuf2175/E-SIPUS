    ...
    <form method="post" action="{{ route('profile.update') }}" class="space-y-6">
                ...
                <div class="mt-3 p-4 bg-yellow-50 border border-yellow-200 rounded-xl">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <button form="send-verification" class="mt-1 text-sm text-yellow-700 underline hover:text-yellow-600 font-medium">
                    ...
                    @if (session('status') === 'verification-link-sent')
                        <p class="mt-3 text-sm text-green-600 font-medium flex items-center gap-1">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div>
            ...
            <div class="flex items-center gap-3">
                @if($user->isAdmin())
                    <span class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold bg-red-100 text-red-800 rounded-xl">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                @elseif($user->isPetugas())
                    <span class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold bg-green-100 text-green-800 rounded-xl">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                        </svg>
                        Petugas
                ...
                @else
                    <span class="inline-flex items-center gap-2 px-4 py-2.5 text-sm font-semibold bg-purple-100 text-purple-800 rounded-xl">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                @endif
                <span class="text-sm text-slate-500">Role cannot be changed by yourself</span>
            </div>
        </div>

        <div class="flex items-center gap-4 pt-4">
            <button type="submit" class="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-3 px-6 rounded-xl transition-all shadow-lg hover:shadow-xl">
