...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | e-SIPUS</title>
...
<body class="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50 flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-lg text-center">
        ...
        <div class="flex flex-col items-center mb-8">
            ...
            <span class="px-4 py-1.5 bg-amber-100 text-amber-600 text-xs font-bold tracking-widest uppercase rounded-full">
                Page Not Found
            </span>
        </div>
