                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="flex items-center gap-4">
                                    <label class="flex-1 flex flex-col items-center px-4 py-6 bg-white border-2 border-gray-300 border-dashed rounded-lg cursor-pointer hover:bg-gray-50 transition">
                                        ...
                                        <span class="mt-2 text-sm text-gray-500">Click to upload cover image</span>
                                    ...
                                    <div id="imagePreview" class="hidden">
                                        <img id="preview" class="h-32 w-24 object-cover rounded-lg border-2 border-gray-300" alt="Preview">
                                    </div>
                                </div>
                                @error('cover_image')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea 
                                    ...
                                    placeholder="Enter book description or synopsis">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
