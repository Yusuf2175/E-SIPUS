...
<aside class="fixed left-3 top-5 w-64 size-cstm bg-gradient-to-br from-ungu via-purple-600 to-secondrys z-40 shadow-xl">
    ...
    <nav class="p-4 space-y-1 pb-8">
        ...
        <div class="pt-3">
            ...
            <a href="{{ route('admin.petugas.index') }}" class="flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-lg transition {{ request()->routeIs('admin.petugas.*') ? 'bg-cstm text-primarys shadow-md' : 'text-cstm/90 hover:bg-primarys/30 hover:text-cstm' }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
