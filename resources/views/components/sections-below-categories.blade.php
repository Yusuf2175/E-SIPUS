    ...
    <section id="categories" class="py-16 lg:py-24 bg-slate-50/80">
        <div class="max-w-6xl mx-auto px-6 md:px-10">
            <div class="text-center mb-14 md:mb-20">
                <h3 class="text-xl md:text-3xl font-extrabold tracking-wide text-slate-900 uppercase mb-4">Kategori Populer</h3>
            </div>
            <div class="relative">
                ...
                <div class="relative flex items-center justify-between mb-14 md:mb-20 w-full">
                    <div class="order-1 w-full md:w-5/12 md:text-left pl-20 md:pl-0 md:pr-16">
                        <div class="bg-white p-6 md:p-8 rounded-4xl shadow-lg border border-purple-50 relative">
                            ...
                            <p class="text-sm text-slate-500 leading-relaxed">Koleksi novel best-seller dan karya sastra klasik dari penulis ternama.</p>
                ...
                <div class="relative flex items-center justify-between mb-14 md:mb-20 w-full">
                    ...
                    <div class="order-2 w-full md:w-5/12 pl-20 md:pl-16">
                        <div class="bg-white p-6 md:p-8 rounded-4xl shadow-lg border border-green-50 relative">
                            ...
                            <p class="text-sm text-slate-500 leading-relaxed">Buku pengetahuan alam, komputer, dan inovasi teknologi terbaru.</p>
                ...
                <div class="relative flex items-center justify-between mb-14 md:mb-20 w-full">
                    <div class="order-1 w-full md:w-5/12 md:text-left pl-20 md:pl-0 md:pr-16">
                        <div class="bg-white p-6 md:p-8 rounded-4xl shadow-lg border border-orange-50 relative">
                            ...
                            <p class="text-sm text-slate-500 leading-relaxed">Panduan bisnis, manajemen, dan ekonomi global.</p>
                ...
                <div class="relative flex items-center justify-between w-full">
                    ...
                    <div class="order-2 w-full md:w-5/12 pl-20 md:pl-16">
                        <div class="bg-white p-6 md:p-8 rounded-4xl shadow-lg border border-blue-50 relative">
                            ...
                            <p class="text-sm text-slate-500 leading-relaxed">Menjelajahi masa lalu dan ragam budaya dunia.</p>
