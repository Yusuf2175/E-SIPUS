    ...
    <div class="mb-8">
        <div class="flex items-start justify-between gap-6">
            <div class="flex-1">
                ...
                <p class="text-lg text-slate-500">Manage your library activities with ease.</p>
            </div>
            
            <!-- CTA Browse Books -->
            <div class="flex-shrink-0">
                <a href="{{ route('books.index') }}" class="inline-flex items-center gap-2 bg-ungu hover:bg-primarys text-white px-5 py-2.5 rounded-lg font-medium text-sm transition-colors shadow-sm">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:-translate-y-1 transition-transform duration-300 cursor-pointer group">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <p class="text-sm text-slate-400 mb-2 font-medium">Currently Borrowed</p>
                    <h3 class="text-4xl font-bold text-slate-900">{{ number_format($stats['active_borrowings']) }}</h3>
                </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:-translate-y-1 transition-transform duration-300 cursor-pointer group">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <p class="text-sm text-slate-400 mb-2 font-medium">Total Borrowings</p>
                    <h3 class="text-4xl font-bold text-slate-900">{{ number_format($stats['total_borrowings']) }}</h3>
                </div>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:-translate-y-1 transition-transform duration-300 cursor-pointer group">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <p class="text-sm text-slate-400 mb-2 font-medium">My Collection</p>
                    <h3 class="text-4xl font-bold text-slate-900">{{ number_format($stats['collections']) }}</h3>
                </div>
                <div class="w-14 h-14 bg-pink-500 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:-rotate-6 transition-transform duration-300">
                    <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:-translate-y-1 transition-transform duration-300 cursor-pointer group">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    <p class="text-sm text-slate-400 mb-2 font-medium">Reviews Given</p>
                    <h3 class="text-4xl font-bold text-slate-900">{{ number_format($stats['reviews']) }}</h3>
                </div>
                <div class="w-14 h-14 bg-amber-500 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:-rotate-6 transition-transform duration-300">
                    <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
