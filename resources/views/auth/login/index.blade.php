                ...
                <div class="p-12">
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="remember" id="remember" class="w-4 h-4 rounded border-slate-300 text-purple-600 focus:ring-purple-500 focus:ring-offset-0 transition">
                            <label for="remember" class="ml-2 text-sm text-slate-600">I agree to the terms of service</label>
                        </div>
